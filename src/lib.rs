...
impl SparkfunQuadStep {
    pub fn new(mot_stp1: u32, mot_stp2: u32, mot_stp3: u32, mot_stp4: u32) -> Result<SparkfunQuadStep, gpio_cdev::Error> {
        ...
        let mot_stp1 = gpio_chip
            .get_line(mot_stp1)?
            .request(LineRequestFlags::OUTPUT, 1, "SparkfunQuadStepDriver")?;
        let mot_stp2 = gpio_chip
            .get_line(mot_stp2)?
            .request(LineRequestFlags::OUTPUT, 1, "SparkfunQuadStepDriver")?;
        let mot_stp3 = gpio_chip
            .get_line(mot_stp3)?
            .request(LineRequestFlags::OUTPUT, 1, "SparkfunQuadStepDriver")?;
        let mot_stp4 = gpio_chip
            .get_line(mot_stp4)?
            .request(LineRequestFlags::OUTPUT, 1, "SparkfunQuadStepDriver")?;
    ...
    // Really important: use this method only if you are using the BUS header of the board(you must weld the BUS enable on the read of the board)
